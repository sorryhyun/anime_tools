...
STAGES: tuple[Stage, ...] = (
    Stage(
        ...
        run="anime_tools.stages.resize:run_resize",
    ...
    Stage(
        ...
        run="anime_tools.stages.autotag:run_autotag",
    ...
    Stage(
        ...
        run="anime_tools.stages.position_captions:run_position",
    ...
    Stage(
        ...
        run="anime_tools.stages.captions:run_correct",
    ...
    Stage(
        ...
        run="anime_tools.stages.multiview_audit:run_audit",
    ...
    Stage(
        ...
        run="anime_tools.stages.ocr:run_ocr",
    ...
    Stage(
        ...
        run="anime_tools.stages.export_workspace:run_export",
