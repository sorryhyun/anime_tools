...
const ko: Dict = {
  ...
  tree: {
    ...
    capDerived: "derived — workspace/resized, 스테이지 출력",
  ...
  caption: {
    ...
    variants: "variants",
    whereVariants:
      "생성된 파일 — v0이 손대지 않은 derived 캡션입니다. 여기서 손으로 고친 내용은 덮어써집니다",
    diffHere: "마지막 실행이 이 버전을 고쳐 씁니다",
    diffElsewhere: (kind: string) => `마지막 실행은 ${kind}을(를) 고쳐 씁니다 — 열기`,
    new: "신규",
    revert: "되돌리기",
    save: "저장",
    saveHint: "⌘/Ctrl+Enter",
